...
const InternetChatPage = () => {
  const apiUrl = '/api/internet';
  const internetChips = [
    'Show internet orders',
    'details for internet product ordered',
    'primary supplier for internet gpu ?',
    ' lead time for the internet GPU supplier?',
    'transportation risk level for internet supplier',
  ];
  ...
  const simulateResponse = async (
    ...
    try {
      ...
      searchParams.set('Query', userPrompt); // Using 'Query' for internet
...
export default InternetChatPage;
